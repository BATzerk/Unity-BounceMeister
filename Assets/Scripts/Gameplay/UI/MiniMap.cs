...
public class MiniMap : MonoBehaviour {
    ...
    // Properties
    private const float mapScale = 0.35f;//0.5f; // SMALLER is smaller tiles. // NOTE: Unity units to Screen units automatically makes rooms way smaller (1 Unity unit is 1 pixel).
